...
- Participant adapter interfaces, fake/manual adapters, HTTP-template participant adapter/profile, OpenAI-compatible participant/extraction/review/finalization components, Resource Broker / Delivery Planner, daemon-local resource delivery planning, short-lived URL access grants, and experimental WebGET support.
