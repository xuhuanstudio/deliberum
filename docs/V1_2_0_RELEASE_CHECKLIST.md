...
- Current branch: `main`.
- Current latest commit at this release-candidate evidence update:
  `80614914ed0491567c67d940c8dbbba09202eacf`
  (`docs(release): align v1.2.0 candidate docs`).
...
- Latest current-branch GitHub CI evidence before this release-notes update:
  `27914188378`, success, for commit
  `80614914ed0491567c67d940c8dbbba09202eacf`.
